...
**Overall Update**:  Mainly *listened* to videos from Brad Schiff's JavaScript course in the Udemy app while driving to & from work.  Supplemented JS learning with Grasshopper coding app a few times.  Another coding app, Career Karma, has proven to be great resource.  Planning on enrolling in Nucamp coding bootcamp in 2020.  Transitioned from being financial analyst to data analyst in late October.  See Links for this log entry.
