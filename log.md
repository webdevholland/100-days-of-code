...
**Today's Summary Progress**:  Continued from yesterday "Scope & Context (Part 1)" in Brad Schiff's JavaScript course (see Links for the day).  Wrapping up on Scope portion of lesson & moving on to Context.
...
* 'let' didn't exist until about 3 or 4 years ago.  If looking at someone else's old code, may see 'var' instead of 'let'.
* 
