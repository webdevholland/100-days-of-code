...
***I'm unfortunately not able to follow the [rules](https://github.com/webdevholland/100-days-of-code/blob/master/rules.md#rules-of-the-100-days-of-code-challenge) of this challenge not only because of my busy schedule, but also because I'm still trying to get to a point where I'm able to build projects to showcase in GitHub.  I'm starting out with simple CodePens to try to demonstrate JS concepts I'm learning.  I jot down notes in a little journal until I get a chance to update my [log.md](log.md) or Tweet my progress [@webdevholland](https://twitter.com/webdevholland).***
