...
*Updated Nov 7, 2019:<br>*
After I completed the [#21DayCkChallenge](https://career-karma.gitbook.io/learn/21dayckchallenge/21dayckchallenge) with [Career Karma](https://careerkarma.com/?p=1) at the end of August 2019, I decided to move on to the #100DaysOfCode challenge as the next adventure on my coding journey.  My main focus as I work through #100DaysOfCode will be Brad Schiff's course, ["Learn JavaScript: Full-Stack from Scratch"](https://www.udemy.com/share/101qIy/) on Udemy.  I'll also post in my [log.md](log.md) about Career Karma, possibly mention other Udemy courses I wishlisted,... basically anything that will help keep coding on my mind nearly everyday :-)

***I'm unfortunately not able to follow the [rules](https://github.com/webdevholland/100-days-of-code/blob/master/rules.md#rules-of-the-100-days-of-code-challenge) of this challenge not only because of my busy schedule, but also because I'm still trying to get to that point where I'm able to build projects to showcase in my GitHub.  For now, I'm starting out with simple CodePens to try to demonstrate JS concepts I'm learning.  I'm also tracking my progress by writing notes in a little journal until I get a chance to update my [log.md](log.md) or Tweet my progress [@webdevholland](https://twitter.com/webdevholland).***
